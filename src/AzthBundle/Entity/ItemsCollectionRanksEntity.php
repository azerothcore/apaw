...
/**
 *
 * @ORM\Entity(repositoryClass="AzthBundle\Repository\ItemsCollectionRanksRepo")
 * @ORM\Table(name="azth_items_collection_rank")
 */
class ItemsCollectionRanksEntity {
    ...
    function getCollectedItems()  { return $this->collectedItems; }
}
